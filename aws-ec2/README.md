...
If you need an advanced EC2 with EBS volume attched than call like this:

```shell


module "maxwell_ec2_dev_with_ebs" {
  source = "./modules/aws-ec2"
  project_name = "maxwell"
  environment  = "dev-advanced"

  instance_suffix = ["rabbitmq-1"]

  public_ip_instances = ["rabbitmq-1"]

  vpc_id       = module.maxwell_dev_vpc.vpc_id

  subnet_map = {
    rabbitmq-1 = module.maxwell_dev_vpc.public_subnet_ids[0]
  ...
  existing_security_group_ids = [ 
    module.ec2_sg_icmp_dev.security_group_icmp_id,
    module.ec2_sg_ssh_dev.security_group_ssh_id,
    module.maxwell_rabbitmq_sq.security_group_id
   ]
