...
variable "public_subnet_ids" {
  type        = list(string)
  description = "List of public subnet IDs for deploying public-facing AWS Load Balancers (ALB)"
}
...
variable "ami_type" {
  description = "AMI ID for nodes (if null, uses latest EKS optimized AMI)"
  type        = string
